...
/**
 * Full ISO 3166-1 alpha-2 country list with names
...
/**
 * Get country by code from the full list
 */
export function getCountryFromCode(code: string | null): { code: string; name: string } | undefined {
