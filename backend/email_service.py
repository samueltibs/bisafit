    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                {"<div class='section'><div class='section-title'>Attachments</div><p>" + str(len(feedback_data.get('bugAttachments', []))) + " file(s) attached - <a href='https://bisafit-enhance.preview.emergentagent.com/admin/analytics'>View in Dashboard</a></p></div>" if feedback_data.get('bugAttachments') else ""}
                ...
                <p style="text-align: center; margin-top: 20px;">
                    <a href="https://bisafit-enhance.preview.emergentagent.com/admin/analytics" 
