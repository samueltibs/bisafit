...
- Name: core-flows.spec.ts >> BisaFit Core Flows >> auth page loads with sign in form
- Location: e2e/core-flows.spec.ts:89:7
...
Locator: locator('text=BisaFit').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=BisaFit').first()
