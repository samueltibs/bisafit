...
- Name: core-flows.spec.ts >> BisaFit Core Flows >> landing page pricing section shows correct prices
- Location: e2e/core-flows.spec.ts:54:7
...
Locator: locator('text=Monthly').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Monthly').first()
