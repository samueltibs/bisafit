...
- Name: core-flows.spec.ts >> BisaFit Core Flows >> landing page footer shows Bisa Group LLC
- Location: e2e/core-flows.spec.ts:72:7
...
Locator: locator('text=Bisa Group LLC').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Bisa Group LLC').first()
